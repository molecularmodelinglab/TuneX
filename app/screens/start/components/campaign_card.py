...
class CampaignCard(QFrame):
    ...
    CAMPAIGN_NAME_OBJECT = "CampaignName"
    CAMPAIGN_DETAILS_OBJECT = "CampaignDetails"
    ...
    def _setup_ui(self):
        ...
        self.name_label.setObjectName(self.CAMPAIGN_NAME_OBJECT)
        info_layout.addWidget(self.name_label)

        self.details_label = QLabel(self._get_campaign_details())
        self.details_label.setObjectName(self.CAMPAIGN_DETAILS_OBJECT)
        info_layout.addWidget(self.details_label)

        self.date_label = QLabel(self._get_last_modified())
        self.date_label.setObjectName(self.CAMPAIGN_DATE_OBJECT)
    ...
    def _setup_styling(self):
        """Setup card styling."""
        self.setObjectName(self.CAMPAIGN_CARD_OBJECT)
